...
export default function ProfitLossModule({
  userProfile,
}: ProfitLossModuleProps) {
  const [dateRange, setDateRange] = useState<DateRangeType>("monthly");

  const canAccess =
    userProfile.appRole === "admin" || userProfile.appRole === "accountant";
  ...
  const {
    ...
    error,
    refetch,
  } = useGetProfitLossReport(startDate, endDate);
    ...
    return (
      <div className="space-y-6">
        <Alert variant="destructive">
          ...
          <AlertDescription>
            You don't have permission to access Profit & Loss Reports. Only
            Accountants and Admins can use this feature.
          </AlertDescription>
        </Alert>
      </div>
    );
  ...
  const handleExportPDF = () => {
    ...
    toast.success(
      "Exporting Profit & Loss Report as PDF with Sahil Garments branding...",
    );
  };
  ...
  const handleExportExcel = () => {
    ...
    toast.success(
      "Exporting Profit & Loss Report as Excel with detailed financial breakdown...",
    );
  };
      ...
      <div className="flex items-center justify-between flex-wrap gap-4">
        <div>
          <h1 className="text-3xl font-bold tracking-tight flex items-center gap-2">
            <img
              src="/assets/generated/enhanced-profit-loss-header.dim_800x200.png"
              alt=""
              className="h-8 w-8"
            />
            Profit & Loss Report
          ...
          <p className="text-muted-foreground mt-1">
            Comprehensive financial analysis with revenue, costs, and profit
            tracking
          </p>
        </div>
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            <Card className="border-l-4 border-l-green-600 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                ...
                <img
                  src="/assets/generated/revenue-icon-transparent.dim_32x32.png"
                  alt=""
                  className="h-4 w-4"
                />
              </CardHeader>
              <CardContent>
                <div className="text-2xl font-bold">
                  {formatCurrency(Number(report.revenue))}
                </div>
            ...
            <Card className="border-l-4 border-l-amber-600 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                ...
                <img
                  src="/assets/generated/cogs-icon-transparent.dim_32x32.png"
                  alt=""
                  className="h-4 w-4"
                />
              </CardHeader>
              <CardContent>
                <div className="text-2xl font-bold">
                  {formatCurrency(Number(report.cogs))}
                </div>
            ...
            <Card className="border-l-4 border-l-blue-600 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                ...
                <img
                  src="/assets/generated/gross-profit-icon-transparent.dim_32x32.png"
                  alt=""
                  className="h-4 w-4"
                />
              </CardHeader>
              <CardContent>
                <div className="text-2xl font-bold">
                  {formatCurrency(Number(report.grossProfit))}
                </div>
                <p className="text-xs text-muted-foreground mt-2">
                  Revenue - COGS
                </p>
            ...
            <Card className="border-l-4 border-l-purple-600 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                ...
                <img
                  src="/assets/generated/net-profit-icon-transparent.dim_32x32.png"
                  alt=""
                  className="h-4 w-4"
                />
              </CardHeader>
              <CardContent>
                ...
                <div className="mt-2 pt-2 border-t">
                  <p
                    className={`text-xs font-medium ${Number(report.netProfit) >= 0 ? "text-green-600" : "text-red-600"}`}
                  >
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between items-center pb-3 border-b">
                    ...
                    <span className="text-lg font-bold text-gray-600">
                      -{formatCurrency(Number(report.expenses))}
                    </span>
                  </div>
                  <div
                    className={`flex justify-between items-center pt-2 p-3 rounded-lg ${Number(report.netProfit) >= 0 ? "bg-green-50 dark:bg-green-950/20" : "bg-red-50 dark:bg-red-950/20"}`}
                  >
                    <span className="text-base font-bold flex items-center gap-2">
                      <div
                        className={`w-3 h-3 rounded-full ${Number(report.netProfit) >= 0 ? "bg-green-600" : "bg-red-600"}`}
                      />
                      Net Profit
                    </span>
                    <span
                      className={`text-2xl font-bold ${Number(report.netProfit) >= 0 ? "text-green-600" : "text-red-600"}`}
                    >
                      {formatCurrency(Number(report.netProfit))}
                    </span>
                  </div>
                ...
                <div className="space-y-4">
                  <div className="p-4 rounded-lg border bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-950/20 dark:to-emerald-950/20">
                    ...
                    <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                      <div
                        ...
                        style={{
                          width: `${Math.min(Number.parseFloat(grossMargin), 100)}%`,
                        }}
                      />
                    </div>
                  </div>
                  ...
                  <div className="p-4 rounded-lg border bg-gradient-to-r from-purple-50 to-violet-50 dark:from-purple-950/20 dark:to-violet-950/20">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span
                        className={`text-2xl font-bold ${Number(report.netProfit) >= 0 ? "text-purple-600" : "text-red-600"}`}
                      >
                        {profitMargin}%
                      </span>
                    </div>
                    <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                      <div
                        ...
                        style={{
                          width: `${Math.min(Math.abs(Number.parseFloat(profitMargin)), 100)}%`,
                        }}
                      />
                    </div>
                  </div>
                  ...
                  <div className="p-4 rounded-lg border bg-gradient-to-r from-amber-50 to-orange-50 dark:from-amber-950/20 dark:to-orange-950/20">
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-sm font-medium">COGS Ratio</span>
                    ...
                    <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                      <div
                        ...
                        style={{
                          width: `${Math.min(Number.parseFloat(cogsPercentage), 100)}%`,
                        }}
                      />
                    </div>
                  </div>
