...
import { Bell, ChevronDown, LogOut, Moon, Shield, Sun } from "lucide-react";
...
export default function Header({
  ...
  const isAdmin: boolean = useIsAdminRole(bootstrapData ?? undefined);
  ...
  const displayName =
    bootstrapData?.userProfile?.name || userProfile?.name || "User";
  const displayRole =
    bootstrapData?.userProfile?.appRole || userProfile?.appRole;
