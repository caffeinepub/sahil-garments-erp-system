...
export function parseApprovalError(error: any): ApprovalErrorInfo {
  ...
  if (
    ...
    return {
      type: "authorization",
      message:
        "You do not have permission to perform this action. Only primary administrators can manage user approvals.",
      backendMessage: errorMessage,
    };
  }
  ...
  if (
    ...
    return {
      ...
      message:
        "This user must complete their profile setup before their approval status can be changed.",
      backendMessage: errorMessage,
    };
  }
  ...
  if (
    ...
    return {
      type: "rejected",
      message:
        "Your account has been rejected. Please contact an administrator for assistance.",
      backendMessage: errorMessage,
    };
  }
...
export function parseProfileSaveError(error: any): ApprovalErrorInfo {
  ...
  if (
    ...
    return {
      ...
      message:
        "You cannot assign privileged roles to yourself during profile creation. Please create your profile first, then contact an administrator to assign the appropriate role.",
      backendMessage: errorMessage,
    };
  }
  ...
  if (
    ...
    return {
      type: "authorization",
      message:
        "You do not have permission to save this profile. Please ensure you are logged in.",
      backendMessage: errorMessage,
    };
  }
  ...
  // Unknown error
  console.log(
    "[Error Parser] Detected: unknown error (no specific pattern matched)",
  );
  console.groupEnd();
  return {
    type: "unknown",
